...
public class AuthApiBusiness {
    ...
    public LoginInfo kakaoLogin(String code) {
        // 인가 코드로 카카오 토큰 요청
        KakaoAccessTokenResponse kakaoToken = kakaoOAuthService.kakaoRequestAccessToken(code);

        // 카카오 사용자 정보 요청
        KakaoUserInfo kakaoUserInfo = kakaoOAuthService.kakaoRequestUserInfo(kakaoToken.getAccessToken());
